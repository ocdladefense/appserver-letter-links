...
options.set("formId", "upload-form");               // The id of the form.  Either the Id of a pre-existing form, or the id that will be given to the form rendered by the js. 
options.set("formAction", "");                      // The action attribute that will be added to the form if it is rendered by the js.  
